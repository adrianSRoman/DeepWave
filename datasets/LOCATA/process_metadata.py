...
def Locata2DecaseFormat(tasks, data_dir, arrays=["eigenmike"], is_dev=True, coord_system="cartesian"):
    ...
    for task_id in tasks:
        ...
        for truth in truth_list:
            out_filename = f'./metadata/eval/task{task_id}_recording{truth.recording_id}.csv'
...
Locata2DecaseFormat(["1", "2", "3", "4"], "/scratch/data/LOCATA/eval", arrays=["eigenmike"], is_dev=True, coord_system="polar")
