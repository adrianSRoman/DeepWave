...
with open('../FRIDA/FRIDA/recordings/20160908/protocol.json') as fd:
...
# print(src_xyz["marker"][:,0])
sphe = cart2sph(src_xyz["marker"][:,3][0], src_xyz["marker"][:,3][1], src_xyz["marker"][:,3][2])
print(sphe)
